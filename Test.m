...
%% Test read EEG data from Brain Vision Recorder
...
%% Load EEG raw data
 ...
 EEG = pop_loadset('filename','00P5_Block_1.set','filepath','Y:\\Freeviewing_EEG_ET\\Daten\\EEG\\separated\\');
[ALLEEG, EEG, CURRENTSET] = eeg_store( ALLEEG, EEG, 0 );

  % "File" > "Import data" > File I/O > select .vdhr file
EEG = pop_fileio('Y:\Freeviewing_EEG_ET\Daten\EEG\EEGET_00P4.vhdr');
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 0,'setname','Test_P4','gui','off'); 
...
% "Eyetracker" > "Parse Eye Tracker raw data" > "text file from Eyelink"
 ...
 ET = parsesmi('Y:\\Freeviewing_EEG_ET\\Daten\\ET\\smi_tr_eeg\\P4_2018_Mrz_12_1053_1 Samples.txt','Y:\\Freeviewing_EEG_ET\\Daten\\EEG\\combineET\\P4_1n.mat','KEYWORD');
